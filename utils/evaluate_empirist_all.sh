...
echo "tiger+empirist"
time ../bin/nlp4py-tagger --train tiger+empirist.$RUN.model --prior tiger.$RUN.model ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+morphy.$RUN.model --lexicon /data/Thomas/morphy_wc.txt <(cut -f1,3 /data/Thomas/tiger_release_aug07.txt)
time ../bin/nlp4py-tagger --train tiger+morphy+empirist.$RUN.model --prior tiger+morphy.$RUN.model --lexicon /data/Thomas/morphy_wc.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+empirist.$RUN.model --prior tiger+decow.$RUN.model --brown /data/Thomas/decow14_brown.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+capit.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/decow14_capitalization_features.txt <(cut -f1,3 /data/Thomas/tiger_release_aug07.txt)
time ../bin/nlp4py-tagger --train tiger+decow+capit+empirist.$RUN.model --prior tiger+decow+capit.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/decow14_capitalization_features.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cut -f1,3 /data/Thomas/tiger_release_aug07.txt)
time ../bin/nlp4py-tagger --train tiger+decow+morphy+empirist.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon morphy+decow14_capitalization.txt <(cut -f1,3 /data/Thomas/tiger_release_aug07.txt)
...
time ../bin/nlp4py-tagger --train tiger+decow+morcap+cmc.$RUN.model --prior tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon morphy+decow14_capitalization.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_cmc_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+morcap+web.$RUN.model --prior tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon morphy+decow14_capitalization.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_web_sent_emo.txt
...
time ../bin/nlp4py-tagger --train tiger+decow+morcap+cmc+extra.$RUN.model --prior tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon morphy+decow14_capitalization.txt <(cat ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_cmc_sent_emo.txt additional_training.txt)
...
time ../bin/nlp4py-tagger --train tiger+decow+morcap+web+extra.$RUN.model --prior tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon morphy+decow14_capitalization.txt <(cat ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_web_sent_emo.txt additional_training.txt)
