...
echo "tiger"
time ../bin/somewe-tagger --train tiger.$RUN.model <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+morphy.$RUN.model --lexicon /data/Thomas/morphy_wc.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
# time ../bin/somewe-tagger --train tiger+dewikiall.$RUN.model --brown /data/Thomas/dewiki_all_brown.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
# time ../bin/somewe-tagger --train tiger+dewikiall+capit.$RUN.model --brown /data/Thomas/dewiki_all_brown.txt --lexicon /data/Thomas/dewiki-20170620_all_capitalization_features.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
# time ../bin/somewe-tagger --train tiger+dewikiall+morphy.$RUN.model --brown /data/Thomas/dewiki_all_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
# time ../bin/somewe-tagger --train tiger+dewikiall+morcap.$RUN.model --brown /data/Thomas/dewiki_all_brown.txt --lexicon morphy+dewikiall_capitalization.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+decow.$RUN.model --brown /data/Thomas/decow14_brown.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+decow+capit.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/decow14_capitalization_features.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+decow+morcap.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy+decow14_capitalization.txt <(cut -f1,3 /data/Thomas/tiger_pav_instead_of_proav.txt)
...
time ../bin/somewe-tagger --train tiger+decow+morphy+empirist+extra.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cat ../data/ignore/empirist_gold_standard/train_all_sent_emo.txt ../data/authentic_additional_training_german_web_social_media.txt)
...
echo "tiger+decow+morphy+cmc"
time ../bin/somewe-tagger --train tiger+decow+morphy+cmc.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt ../data/ignore/empirist_gold_standard/train_cmc_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+cmc.$RUN.model ../data/ignore/empirist_gold_standard/test_cmc_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+cmc.$RUN.model ../data/ignore/empirist_gold_standard/test_web_sent_emo.txt

echo "tiger+decow+morphy+web"
time ../bin/somewe-tagger --train tiger+decow+morphy+web.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt ../data/ignore/empirist_gold_standard/train_web_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+web.$RUN.model ../data/ignore/empirist_gold_standard/test_cmc_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+web.$RUN.model ../data/ignore/empirist_gold_standard/test_web_sent_emo.txt

echo "tiger+decow+morphy+cmc+extra"
time ../bin/somewe-tagger --train tiger+decow+morphy+cmc+extra.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cat ../data/ignore/empirist_gold_standard/train_cmc_sent_emo.txt ../data/authentic_additional_training_german_web_social_media.txt)
../bin/somewe-tagger --evaluate tiger+decow+morphy+cmc+extra.$RUN.model ../data/ignore/empirist_gold_standard/test_cmc_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+cmc+extra.$RUN.model ../data/ignore/empirist_gold_standard/test_web_sent_emo.txt

echo "tiger+decow+morphy+web+extra"
time ../bin/somewe-tagger --train tiger+decow+morphy+web+extra.$RUN.model --prior tiger+decow+morphy.$RUN.model --brown /data/Thomas/decow14_brown.txt --lexicon /data/Thomas/morphy_wc.txt <(cat ../data/ignore/empirist_gold_standard/train_web_sent_emo.txt ../data/authentic_additional_training_german_web_social_media.txt)
../bin/somewe-tagger --evaluate tiger+decow+morphy+web+extra.$RUN.model ../data/ignore/empirist_gold_standard/test_cmc_sent_emo.txt
../bin/somewe-tagger --evaluate tiger+decow+morphy+web+extra.$RUN.model ../data/ignore/empirist_gold_standard/test_web_sent_emo.txt
