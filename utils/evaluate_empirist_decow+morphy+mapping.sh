...
time ../bin/nlp4py-tagger --train tiger+decow+morphy+mapping+empirist.model --prior tiger+decow+morphy+mapping.model --brown /data/decow14_brown.txt --lexicon /cip/corpora/Lexicon/Morphy/morphy_wc.txt  --mapping ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/stts2_to_upos.json ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
