...
time ../bin/nlp4py-tagger --train tiger+decow+morcap+empirist.model --prior tiger+decow+morcap.model --brown /data/decow14_brown.txt --lexicon morphy+capitalization.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
