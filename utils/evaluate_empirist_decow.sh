...
time ../bin/nlp4py-tagger --train tiger+decow+empirist.model --prior tiger+decow.model --brown /data/decow14_brown.txt ~/Documents/Arbeit/nlp4py/data/empirist_gold_standard/train_all_sent_emo.txt
